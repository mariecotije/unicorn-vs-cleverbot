...
// const messageRemote = document.querySelector(".message--remote");
// const messageLocal = document.querySelector(".message--local");

// conversation.forEach(message => {

//   if (message.side === "remote") {
//     messageRemote.innerHTML += `<div class="message__text">${message.text}</div>`
//   } else if (message.side === "local") {
//     messageLocal.innerHTML += `<div class="message__text">${message.text}</div>`
//   };

//   setTimeout(() => {
//     console.log("timeout");
//   }, 500); // Set a delay of 500 milliseconds before displaying the next message
